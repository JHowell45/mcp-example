...
Revision ID: f1ad25bb4571
Revises: c8f4bae6a505
Create Date: 2025-08-11 00:47:55.392086
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("spoken_language_id", "film_id"),
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("filmspokenlanguagelink")
